...
export function maximumBastion(root = ROOT) {
  ...
  const allowed = new Set(['config/dev-v4/central-contract.v1.json', 'config/dev-v4/impact-hub-capabilities.v1.json', 'config/dev-v4/negative-fixtures.v1.json', 'config/dev-v4/stage-b-policy.v1.json', 'scripts/dev-v4-stage-a-verifier.mjs', 'scripts/dev-v4-stage-b-adapter.mjs', 'tests/dev-v4-stage-a.test.mjs', 'tests/dev-v4-stage-b.test.mjs', 'docs/dev-plans/DEV-V4-IMPACT-HUB-STAGE-A-20260911.md', 'docs/dev-plans/DEV-V4-IMPACT-HUB-STAGE-B-20260911.md', 'docs/continuity/dev/2026-09-11-dev-v4-impact-hub-stage-a.md', 'docs/continuity/dev/2026-09-11-dev-v4-impact-hub-stage-b.md', 'notes.md', 'system-status-snapshot.md']);
  const violations = [];
